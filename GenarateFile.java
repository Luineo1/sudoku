...
public class GenarateFile {
    ...
    public static void main(String[] args) {
        ...
        File Ffichero=new File("D:\\proyectos\\sit\\alcoholes\\ActivarMovimientoAlcoholes.java");
        EcribirFichero(Ffichero,"Juan");
        EcribirFichero(Ffichero,"Ana");
        EcribirFichero(Ffichero,"Pedro");
        ModificarFichero(Ffichero,"ActivarMovimiento","Maria");
        ...
        try {
            ...
            if(FficheroAntiguo.exists()){
                ...
                while((Slinea=Flee.readLine())!=null) { 
                    ...
                    if (Slinea.indexOf(Satigualinea) != -1) {
                        /*Escribo la nueva linea en vez de la que tenia*/
                         EcribirFichero(FficheroNuevo,Slinea.replaceAll(Satigualinea, Snuevalinea));
                    }else{
